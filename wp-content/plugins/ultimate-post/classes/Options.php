        ...
        if ($current) {
            ...
            echo '<div class="ultp-settings-tab-wrap">';
                if ($date_condition  && !$pro_active) {
                    ...
                    if (!$pro_active) {
                        // From 2.9.9
                        echo '<div class="ultp-setting-hellobar"><span class="dashicons dashicons-bell ultp-ring"></span><strong> PostX Dynamic Site Builder : </strong> Save up to 80% of your development time - <a href="'.esc_url(ultimate_post()->get_premium_link( 'https://www.wpxpo.com/postx-dynamic-site-builder/', 'menu_topbar')).'" target="_blank">'.esc_html__('Learn More', 'ultimate-post').'</a></div>';
                    }
                }
